...
extern "C" {
    ...
    int make_term_from_dom(ErlNifEnv* env, simdjson::dom::element element, ERL_NIF_TERM* term);
    ...
    int make_term_from_dom(ErlNifEnv* env, simdjson::dom::element element, ERL_NIF_TERM* term)
    {
        //TODO: ensure the compiler does tail-call optimization 
        switch (element.type()) {
